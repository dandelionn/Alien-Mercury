...
{
    public partial class AdvancedVScrollbar : UserControl
    {
        ...
        private void SetScrollingInfo(IntPtr handle, Orientation orientation, int value)
        {
            ...
            int nPos = ScrollbarValueConverter.ConvertValueToStandardVertical(_richTextBox[0], ThumbPosition);
